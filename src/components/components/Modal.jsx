										...
										<div className="row">
											<div className="col-12">
												<div className="modal-product-img">
													<img src={process.env.PUBLIC_URL + "/assets/img/product/7.png"} alt="#" />
												</div>
												...
												<div className="additional-info d-none">
													...
													<div className="payment-method">
														<img src={process.env.PUBLIC_URL + "/assets/img/icons/payment.png"} alt="#" />
													</div>
												</div>
											</div>
										</div>
									...
									<div className="modal-product-item">
										<div className="row">
											<div className="col-lg-6 col-12">
												<div className="modal-product-img">
													<img src={process.env.PUBLIC_URL + "/assets/img/product/4.png"} alt="#" />
												</div>
											</div>
											<div className="col-lg-6 col-12">
								...
								<div className="ltn__quick-view-modal-inner">
									<div className="modal-product-item">
										<div className="row">
											<div className="col-12">
												<div className="modal-product-img">
													<img src={process.env.PUBLIC_URL + "/assets/img/product/1.png"} alt="#" />
												</div>
												<div className="modal-product-info go-top">

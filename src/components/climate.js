...
import {ResponsiveContainer, ComposedChart, Bar,Area, XAxis, YAxis, Tooltip,CartesianGrid, Line, Legend} from 'recharts';
...
return(
    <div ><h4>Monthly Averages from 1981 - 2010</h4><div id='sub-plot'>
    <ResponsiveContainer>
        <ComposedChart
        data={data}
        ...
        <Line type="monotone" strokeWidth={1.5} dataKey="Avg Temp" stroke="#387908" yAxisId={0} />
        <Line type="monotone" strokeWidth={1.5} dataKey="Low Temp" stroke="#0000ff" yAxisId={0} />
        <Line type="monotone" strokeWidth={1.5} dataKey="High Temp" stroke="#ff0000" yAxisId={0} />
